...
import type { AnyMessageContent, SocketConfig, WAMessage } from '../Types/index.js';
import type { BinaryNode } from '../WABinary/index.js';
export declare const makeButtonsSocket: (config: SocketConfig) => {
    sendButtonMessage: (jid: string, content: any, options?: any) => Promise<WAMessage | undefined>;
    sendTemplateMessage: (jid: string, content: any, options?: any) => Promise<WAMessage | undefined>;
    sendListMessage: (jid: string, content: any, options?: any) => Promise<WAMessage | undefined>;
    ...
    communityAcceptInviteV4: (key: string | import("../index.js").WAMessageKey, inviteMessage: proto.Message.IGroupInviteMessage) => Promise<any>;
    ...
    sendMessage: (jid: string, content: AnyMessageContent, options?: import("../index.js").MiscMessageGenerationOptions) => Promise<WAMessage | undefined>;
    ...
    groupAcceptInviteV4: (key: string | import("../index.js").WAMessageKey, inviteMessage: proto.Message.IGroupInviteMessage) => Promise<any>;
