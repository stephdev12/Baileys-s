...
import { generateWAMessageFromContent, proto } from '../WAProto/index.js';
...
export const makeMessagesSocket = (config) => {
    ...
    /**
 * Send buttons message with viewOnce wrapper
 */
export const sendButtonsMessage = (jid, content, options = {}) => {
    const message = {
        viewOnceMessage: {
            message: {
                messageContextInfo: {
...
/**
 * Send interactive message (modern method)
 */
export const sendInteractiveMessage = async (jid, content) => {
    let header = undefined;
    
    if (content.image) {
        header = {
            hasMediaAttachment: true,
            imageMessage: content.image
        };
    } else if (content.video) {
        header = {
            hasMediaAttachment: true,
            videoMessage: content.video
        };
        ...
        viewOnceMessage: {
            message: {
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                    ...
                    footer: content.footer ? proto.Message.InteractiveMessage.Footer.create({
                        text: content.footer
                    }) : undefined,
                    header: header ? proto.Message.InteractiveMessage.Header.create(header) : undefined,
 ...
 * Send list message
 */
export const sendListMessage = (jid, content) => {
    const message = {
        listMessage: {
            title: content.title,
 ...
 */
export const sendCarouselMessage = (jid, content) => {
    const message = {
        viewOnceMessage: {
            message: {
                messageContextInfo: {
