...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
    sendButtonMessage: (jid: string, content: any, options?: any) => Promise<import("../index.js").WAMessage | undefined>;
    sendTemplateMessage: (jid: string, content: any, options?: any) => Promise<import("../index.js").WAMessage | undefined>;
    sendListMessage: (jid: string, content: any, options?: any) => Promise<import("../index.js").WAMessage | undefined>;
